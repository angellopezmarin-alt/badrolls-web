...
function listenLinks(spotifyUrl,ivooxUrl){
 ...
 return `<div class="listen-row"><span class="listen-label">Escuchar</span><div class="platform-links"><a class="platform-link spotify" href="${spotifyTarget}" target="_blank" rel="noopener" aria-label="Escuchar el último episodio de Badrolls en Spotify">${spotifyIcon}<span>Spotify</span></a><a class="platform-link ivoox" href="${ivooxTarget}" target="_blank" rel="noopener" aria-label="Escuchar el último episodio de Badrolls en iVoox">${ivooxLogo}</a></div></div>`
}
