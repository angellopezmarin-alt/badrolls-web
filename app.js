...
function listenLinks(ivooxEpisodeUrl){
 const ivooxTarget=esc(ivooxEpisodeUrl||IVOOX_SHOW);
 return `<div class="listen-row"><span class="listen-label">Escuchar</span><div class="platform-links"><a class="platform-link spotify" href="${SPOTIFY_SHOW}" target="_blank" rel="noopener" aria-label="Escuchar Badrolls en Spotify">${spotifyIcon}<span>Spotify</span></a><a class="platform-link ivoox" href="${ivooxTarget}" target="_blank" rel="noopener" aria-label="Escuchar el último episodio de Badrolls en iVoox">${ivooxLogo}</a></div></div>`
}
...
async function loadPodcast(){
 ...
 try{
  ...
  const episodeUrl=latest.link||latest.guid||IVOOX_SHOW;
